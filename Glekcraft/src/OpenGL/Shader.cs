...
public class Shader : IDisposable {
    ...
    /// </param>
    /// <param name="path">
    /// The path to the file containing the source code to upload and compile
    /// with.
    /// </param>
    /// <returns>
    /// The new instance.
    ...
    /// </summary>
    /// <param name="sources">
    /// The source code to upload. Each element in the array will be uploaded as
    /// a separate line.
    /// </param>
    /// <returns>
